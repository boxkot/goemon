...
<form action="{{ site_url }}admin_user/add/" method="post" style="width: 600px">
  <textarea name="mail" class="form-control" rows="10"></textarea>
  <input type="submit" class="btn btn-primary-btn-lg active" value="ユーザー仮登録">
</form>
